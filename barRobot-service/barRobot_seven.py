...
_songList1 = ['sounds/1.wav', 'sounds/2.wav', 'sounds/3.wav','sounds/4.wav']
...
if __name__=='__main__':
    try:
        ...
        #pygame.mixer.music.play(-1)
        play_a_different_song(_sevenList)
...
#        pygame.mixer.music.queue('sound/muenze2.wav')
        buttonM.when_pressed =sv_muenze_eingeworfen
